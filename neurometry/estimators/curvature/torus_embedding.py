...
class NeuralEmbedding(torch.nn.Module):
    def __init__(self, input_dim=2, output_dim=128, hidden_dims=64, num_hidden = 4, sft_beta=4.5):
        super().__init__()
...
class Trainer:
    def __init__(self, model, train_loader, test_loader, criterion, learning_rate, scheduler=False):
        self.model = model
