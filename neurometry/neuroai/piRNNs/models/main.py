...
def run_experiment(sweep_name, s_0, sigma_saliency, x_saliency, plot=True):
    ...
    sweep_config = {
        "lr": rng.choice(default_config.lr),
        "w_trans": rng.choice(default_config.w_trans),
        "rnn_step": rng.choice(default_config.rnn_step),
        "n_inte_step": rng.choice(default_config.n_inte_step),
    }
